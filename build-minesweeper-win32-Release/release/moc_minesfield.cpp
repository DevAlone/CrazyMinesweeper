...
QT_MOC_LITERAL(1, 11, 8), // "userLost"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 7) // "userWon"

    },
    "MinesField\0userLost\0\0userWon"
};
...
void MinesField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->userLost(); break;
        case 1: _t->userWon(); break;
        default: ;
        }
        ...
        {
            typedef void (MinesField::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MinesField::userLost)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MinesField::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MinesField::userWon)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject MinesField::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MinesField.data,
...
// SIGNAL 0
void MinesField::userLost()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void MinesField::userWon()
{
